...
STUDENT_TEST("Test correct countZeroSumSubsets against buggyCount") {
    ...
    nums = {3, 1, -3};
    EXPECT_EQUAL(buggyCount(nums, 0, 0), 2);
}


STUDENT_TEST("Test buggyCount: 3, -3") {
    Vector<int> nums = {};
...
STUDENT_TEST("Test correct countZeroSumSubsets") {
    Vector<int> nums = {};

    nums = {3, -3};
    EXPECT_EQUAL(countZeroSumSubsets(nums, 0, 0), 2);
}
...
STUDENT_TEST("Test correct countZeroSumSubsets against buggyCount") {
    ...
    nums = {1};
    EXPECT_EQUAL(buggyCount(nums, 0, 0), 0);
}
